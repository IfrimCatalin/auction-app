    ...
    <main className={pageShell}>
      <header className="sticky top-0 z-30 border-b border-border/80 bg-page/90 backdrop-blur">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/auctions" className={btnSecondary}>
              Auctions
            </Link>
          </div>
        </nav>
      ...
      <div className="mx-auto max-w-6xl space-y-8 px-5 py-10 lg:px-8">
        <div>
          ...
          <h1 className={`${headingPage} mt-2`}>Admin dashboard</h1>
          <p className={`${sectionMuted} mt-2 max-w-2xl`}>
            Review marketplace activity, cancel listings, or hide them from public auctions.
          </p>
        </div>
