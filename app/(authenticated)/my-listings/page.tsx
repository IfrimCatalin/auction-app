  ...
  return (
    <AuthenticatedSection>
      <PageHeader
        ...
        actions={<ButtonLink href="/create-listing">+ New listing</ButtonLink>}
      />

      {error ? (
        <p className={`${errorBox} mt-8`}>Could not load listings: {error.message}</p>
      ) : null}
      ...
      {!error && listings.length === 0 ? (
        <EmptyState
          ...
          description="Create your first listing to start receiving bids."
